...
class _CardRegisterState extends State<CardRegister> {
  ...
  void _saveFrom() async{
    ...
    //저장 로직 추가
    bool result = await cardController.cardRegister(position, organization, address, tell, email, fileId);
    ...
    return Scaffold(
      ...
      body: Expanded(
        child: ListView(
          ...
          children: [
            ImageButton(
              imageUrl: fileId == null? null : "${Global.apiRoot}/api/cards/register/",
              onTap: uploadImage,
            ),
